// ════════════════════════════════════════════════════════════════
// GuardMan — Registro único de iconos SVG del sitio.
// Todos los iconos comparten: viewBox 24x24, stroke="currentColor", stroke-width="2",
// sin width/height (el componente <Icon> inyecta tamaño).
// Migración 1:1 de `src/ssr/site-renderer.ts` (const I, SERVICE_ICONS, SECTOR_ICONS).
// ════════════════════════════════════════════════════════════════
...
export const ICONS = {
  ...
  dna: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>',
  radar: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>',
  ...
  youtube: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 2A29.94 29.94 0 001 11.75a29.94 29.94 0 00.46 5.33A2.78 2.78 0 003.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 001.94-2 29.94 29.94 0 00.46-5.25 29.94 29.94 0 00-.46-5.33z"/><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"/></svg>',
  ...
  pipeline: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="5" height="18" rx="1"/><rect x="10" y="3" width="5" height="12" rx="1"/><rect x="17" y="3" width="5" height="8" rx="1"/></svg>',
  ...
  arrowUpRight: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="7" y1="17" x2="17" y2="7"/><polyline points="7 7 17 7 17 17"/></svg>',
  clock3: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',
  ...
  'alert-triangle': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',
  ...
  scale: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v18"/><path d="M5 7h14"/><path d="M5 7l-3 7a4 4 0 0 0 8 0l-3-7"/><path d="M19 7l-3 7a4 4 0 0 0 8 0l-3-7"/></svg>',
...
// Iconos por servicio (matching Open Design). key = slug del servicio.
export const SERVICE_ICONS: Record<string, string> = {
  ...
  'seguridad-deportiva': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 2 L14.5 7 L20 7.5 L16 11 L17 16.5 L12 13.5 L7 16.5 L8 11 L4 7.5 L9.5 7 Z"/></svg>',
  ...
  aseo: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 4l1 2M14 4l-1 2M9 18l1-2M14 18l-1-2M4 9l2 1M4 14l2-1M18 9l-2 1M18 14l-2-1"/><circle cx="12" cy="12" r="3"/><path d="M12 8v1M12 15v1M8 12h1M15 12h1"/></svg>',
};

// Iconos por sector. key = slug del sector. Reemplazan los emojis (🏠🏢🏭🚧🏫🎪🏨🏥🚗) del hub.
export const SECTOR_ICONS: Record<string, string> = {
  residencial: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>',
  comercial: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',
  industrial: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20h20"/><path d="M5 20V8l5 3V8l5 3V8l5 3v9"/><rect x="7" y="14" width="2" height="3"/><rect x="12" y="14" width="2" height="3"/></svg>',
  construccion: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 18h20"/><path d="M4 18v-4l4-2 4 2v4"/><path d="M12 18v-7l4-2 4 2v7"/><path d="M4 14V8h4v2"/><path d="M12 11V6h4v1"/></svg>',
  educacion: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 10v6"/><path d="M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c0 2 3 3 6 3s6-1 6-3v-5"/></svg>',
  eventos: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 9l10-6 10 6"/><path d="M5 9v11a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9"/><line x1="12" y1="13" x2="12" y2="17"/></svg>',
  hoteleria: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 4v16"/><path d="M22 4v16"/><path d="M2 8h20"/><path d="M2 16h20"/><path d="M12 4v16"/><path d="M7 12h10"/></svg>',
  salud: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>',
  automotriz: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 17h14"/><path d="M3 17v-5l2-5h14l2 5v5"/><circle cx="7.5" cy="17.5" r="1.5"/><circle cx="16.5" cy="17.5" r="1.5"/><line x1="3" y1="13" x2="21" y2="13"/></svg>',
  deportivo: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 2 L14.5 7 L20 7.5 L16 11 L17 16.5 L12 13.5 L7 16.5 L8 11 L4 7.5 L9.5 7 Z"/></svg>',
};

// Helper para renderizar un icono por nombre
export function icon(name: keyof typeof ICONS): string {
  return ICONS[name];
}

// Helper para renderizar el icono de un servicio por slug
export function serviceIcon(slug: string): string | null {
  return SERVICE_ICONS[slug] ?? null;
}

// Helper para renderizar el icono de un sector por slug
export function sectorIcon(slug: string): string | null {
  return SECTOR_ICONS[slug] ?? null;
}
